  ...
  const capabilitiesList = [
    {
      ...
      image: '/capabilities_image_01.png',
    },
    {
      title: 'WordPress',
      ...
      image: '/capabilities_image_02.png',
    },
    {
      title: 'フロントエンド実装',
      text: 'Nuxt.jsやNext.jsを使用した、Webアプリケーションのフロントエンド実装にも取り組んでいます。\n実務での経験を重ねながら、現在はAstroなどの技術習得にも取り組み、対応できる実装の幅を広げたいと考えています。\n今後は、機能を形にするだけでなく、UIの分かりやすさや操作体験にも配慮した実装ができるよう、フロントエンド領域のスキルをさらに磨いていきたいです。',
      image: '/capabilities_image_03.png',
    },
  ];
